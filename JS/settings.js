    ...
    container.innerHTML = `
        <div style="padding: 20px;padding-bottom: 100px;">
            ...
            <div class="setting-card" style="background: rgba(255,255,255,0.9); padding: 15px; border-radius: 12px; margin-bottom: 20px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
                ...
                <p style="font-size: 12px; color: #999; margin: 8px 0 0; line-height: 1.6;">这里不依赖历史记录。会直接按当前代码为你生成当前角色在不同场景下的提示词全貌，方便你检查线上私聊、线下见面、朋友圈、音乐、语音/视频通话等链路有没有把核心思想吃进去。</p>
...
function testBrowserNotificationForExperiment() {
    try {
        ...
        window.BrowserNotificationBridge.show('角色消息测试', '这是一条浏览器通知测试消息。你现在切出页面后，也会走这条通知链路。', {
